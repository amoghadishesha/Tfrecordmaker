...
from gutils import _dataset_exists, _get_filenames_and_classes, write_label_file, _convert_dataset

#===============DEFINE YOUR ARGUMENTS==============
flags = tf.app.flags

#State your dataset directory
flags.DEFINE_string('dataset_dir', 'INSERT FILEPATH TO DIRECTORY', 'String: Your dataset directory')
...
flags.DEFINE_string('tfrecord_filename', 'INSERT OUTPUT FILEPATH', 'String: The output filename to name your TFRecord file')
